...
int fsck_msg_type(enum fsck_msg_id msg_id, struct fsck_options *options)
{
	...
	case FSCK_MSG_BAD_NAME:
	case FSCK_MSG_BAD_PARENT_SHA1:
	case FSCK_MSG_BAD_TIMEZONE:
	case FSCK_MSG_BAD_TREE_SHA1:
	case FSCK_MSG_DATE_OVERFLOW:
	case FSCK_MSG_DUPLICATE_ENTRIES:
	case FSCK_MSG_INVALID_OBJECT_SHA1:
	case FSCK_MSG_INVALID_TAG_OBJECT:
	case FSCK_MSG_INVALID_TREE:
	case FSCK_MSG_INVALID_TYPE:
	case FSCK_MSG_MISSING_AUTHOR:
	case FSCK_MSG_MISSING_COMMITTER:
	case FSCK_MSG_MISSING_EMAIL:
	case FSCK_MSG_MISSING_GRAFT:
	case FSCK_MSG_MISSING_NAME_BEFORE_EMAIL:
	case FSCK_MSG_MISSING_OBJECT:
	case FSCK_MSG_MISSING_PARENT:
	case FSCK_MSG_MISSING_SPACE_BEFORE_DATE:
	case FSCK_MSG_MISSING_SPACE_BEFORE_EMAIL:
	case FSCK_MSG_MISSING_TAG:
	case FSCK_MSG_MISSING_TAG_ENTRY:
	case FSCK_MSG_MISSING_TAG_OBJECT:
	case FSCK_MSG_MISSING_TREE:
	case FSCK_MSG_MISSING_TYPE:
	case FSCK_MSG_MISSING_TYPE_ENTRY:
	case FSCK_MSG_NOT_SORTED:
	case FSCK_MSG_NUL_IN_HEADER:
	case FSCK_MSG_TAG_OBJECT_NOT_TAG:
	...
	case FSCK_MSG_FULL_PATHNAME:
	case FSCK_MSG_HAS_DOT:
	case FSCK_MSG_HAS_DOTDOT:
	case FSCK_MSG_HAS_DOTGIT:
	case FSCK_MSG_INVALID_TAG_NAME:
	case FSCK_MSG_MISSING_TAGGER_ENTRY:
	case FSCK_MSG_NULL_SHA1:
	case FSCK_MSG_ZERO_PADDED_FILEMODE:
		return FSCK_WARN;
	}

	error("Unhandled fsck msg id: %d", msg_id);
	return FSCK_ERROR;
}
